...
// SPRUCE
craftingTable.addShaped("spruce_pressure_plate_saw", <item:minecraft:spruce_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:spruce_planks>, <item:minecraft:spruce_planks>]]);
craftingTable.addShaped("spruce_planks_from_stripped", <item:minecraft:spruce_planks>*6, [[<item:minecraft:stripped_spruce_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("spruce_planks_from_log", <item:minecraft:spruce_planks>*6, [[<item:minecraft:spruce_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("spruce_post_stripped_saw", <item:quark:stripped_spruce_post>*6, [[<item:minecraft:stripped_spruce_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_spruce_log>, air]]);
craftingTable.addShaped("spruce_post_saw", <item:quark:spruce_post>*6, [[<item:minecraft:spruce_log>, <tag:items:kapphobins:saw>],[<item:minecraft:spruce_log>, air]]);
...
// BIRCH
craftingTable.addShaped("birch_pressure_plate_saw", <item:minecraft:birch_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:birch_planks>, <item:minecraft:birch_planks>]]);
craftingTable.addShaped("birch_planks_from_stripped", <item:minecraft:birch_planks>*6, [[<item:minecraft:stripped_birch_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("birch_planks_from_log", <item:minecraft:birch_planks>*6, [[<item:minecraft:birch_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("birch_post_stripped_saw", <item:quark:stripped_birch_post>*6, [[<item:minecraft:stripped_birch_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_birch_log>, air]]);
craftingTable.addShaped("birch_post_saw", <item:quark:birch_post>*6, [[<item:minecraft:birch_log>, <tag:items:kapphobins:saw>],[<item:minecraft:birch_log>, air]]);
...
// JUNGLE
craftingTable.addShaped("jungle_pressure_plate_saw", <item:minecraft:jungle_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:jungle_planks>, <item:minecraft:jungle_planks>]]);
craftingTable.addShaped("jungle_planks_from_stripped", <item:minecraft:jungle_planks>*6, [[<item:minecraft:stripped_jungle_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("jungle_planks_from_log", <item:minecraft:jungle_planks>*6, [[<item:minecraft:jungle_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("jungle_post_stripped_saw", <item:quark:stripped_jungle_post>*6, [[<item:minecraft:stripped_jungle_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_jungle_log>, air]]);
craftingTable.addShaped("jungle_post_saw", <item:quark:jungle_post>*6, [[<item:minecraft:jungle_log>, <tag:items:kapphobins:saw>],[<item:minecraft:jungle_log>, air]]);
...
// ACACIA
craftingTable.addShaped("acacia_pressure_plate_saw", <item:minecraft:acacia_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:acacia_planks>, <item:minecraft:acacia_planks>]]);
craftingTable.addShaped("acacia_planks_from_stripped", <item:minecraft:acacia_planks>*6, [[<item:minecraft:stripped_acacia_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("acacia_planks_from_log", <item:minecraft:acacia_planks>*6, [[<item:minecraft:acacia_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("acacia_post_stripped_saw", <item:quark:stripped_acacia_post>*6, [[<item:minecraft:stripped_acacia_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_acacia_log>, air]]);
craftingTable.addShaped("acacia_post_saw", <item:quark:acacia_post>*6, [[<item:minecraft:acacia_log>, <tag:items:kapphobins:saw>],[<item:minecraft:acacia_log>, air]]);
...
// DARK OAK
craftingTable.addShaped("dark_oak_pressure_plate_saw", <item:minecraft:dark_oak_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:dark_oak_planks>, <item:minecraft:dark_oak_planks>]]);
craftingTable.addShaped("dark_oak_planks_from_stripped", <item:minecraft:dark_oak_planks>*6, [[<item:minecraft:stripped_dark_oak_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("dark_oak_planks_from_log", <item:minecraft:dark_oak_planks>*6, [[<item:minecraft:dark_oak_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("dark_oak_post_stripped_saw", <item:quark:stripped_dark_oak_post>*6, [[<item:minecraft:stripped_dark_oak_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_dark_oak_log>, air]]);
craftingTable.addShaped("dark_oak_post_saw", <item:quark:dark_oak_post>*6, [[<item:minecraft:dark_oak_log>, <tag:items:kapphobins:saw>],[<item:minecraft:dark_oak_log>, air]]);
...
// MANGROVE
craftingTable.addShaped("mangrove_pressure_plate_saw", <item:minecraft:mangrove_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:mangrove_planks>, <item:minecraft:mangrove_planks>]]);
craftingTable.addShaped("mangrove_planks_from_stripped", <item:minecraft:mangrove_planks>*6, [[<item:minecraft:stripped_mangrove_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("mangrove_planks_from_log", <item:minecraft:mangrove_planks>*6, [[<item:minecraft:mangrove_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("mangrove_post_stripped_saw", <item:quark:stripped_mangrove_post>*6, [[<item:minecraft:stripped_mangrove_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_mangrove_log>, air]]);
craftingTable.addShaped("mangrove_post_saw", <item:quark:mangrove_post>*6, [[<item:minecraft:mangrove_log>, <tag:items:kapphobins:saw>],[<item:minecraft:mangrove_log>, air]]);
...
// CHERRY
craftingTable.addShaped("cherry_pressure_plate_saw", <item:minecraft:cherry_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:cherry_planks>, <item:minecraft:cherry_planks>]]);
craftingTable.addShaped("cherry_planks_from_stripped", <item:minecraft:cherry_planks>*6, [[<item:minecraft:stripped_cherry_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("cherry_planks_from_log", <item:minecraft:cherry_planks>*6, [[<item:minecraft:cherry_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("cherry_post_stripped_saw", <item:quark:stripped_cherry_post>*6, [[<item:minecraft:stripped_cherry_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_cherry_log>, air]]);
craftingTable.addShaped("cherry_post_saw", <item:quark:cherry_post>*6, [[<item:minecraft:cherry_log>, <tag:items:kapphobins:saw>],[<item:minecraft:cherry_log>, air]]);
...
// BAMBOO
craftingTable.addShaped("bamboo_pressure_plate_saw", <item:minecraft:bamboo_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:bamboo_planks>, <item:minecraft:bamboo_planks>]]);
craftingTable.addShaped("bamboo_planks_from_stripped", <item:minecraft:bamboo_planks>*6, [[<item:minecraft:stripped_bamboo_block>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("bamboo_planks_from_log", <item:minecraft:bamboo_planks>*6, [[<item:minecraft:bamboo_block>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("bamboo_post_stripped_saw", <item:quark:stripped_bamboo_post>*6, [[<item:minecraft:stripped_bamboo_block>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_bamboo_block>, air]]);
craftingTable.addShaped("bamboo_post_saw", <item:quark:bamboo_post>*6, [[<item:minecraft:bamboo_block>, <tag:items:kapphobins:saw>],[<item:minecraft:bamboo_block>, air]]);
...
// CRIMSON
craftingTable.addShaped("crimson_pressure_plate_saw", <item:minecraft:crimson_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:crimson_planks>, <item:minecraft:crimson_planks>]]);
craftingTable.addShaped("crimson_planks_from_stripped", <item:minecraft:crimson_planks>*6, [[<item:minecraft:stripped_crimson_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("crimson_planks_from_log", <item:minecraft:crimson_planks>*6, [[<item:minecraft:crimson_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("crimson_post_stripped_saw", <item:quark:stripped_crimson_post>*6, [[<item:minecraft:stripped_crimson_stem>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_crimson_stem>, air]]);
craftingTable.addShaped("crimson_post_saw", <item:quark:crimson_post>*6, [[<item:minecraft:crimson_stem>, <tag:items:kapphobins:saw>],[<item:minecraft:crimson_stem>, air]]);
...
// WARPED
craftingTable.addShaped("warped_pressure_plate_saw", <item:minecraft:warped_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:warped_planks>, <item:minecraft:warped_planks>]]);
craftingTable.addShaped("warped_planks_from_stripped", <item:minecraft:warped_planks>*6, [[<item:minecraft:stripped_warped_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("warped_planks_from_log", <item:minecraft:warped_planks>*6, [[<item:minecraft:warped_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("warped_post_stripped_saw", <item:quark:stripped_warped_post>*6, [[<item:minecraft:stripped_warped_stem>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_warped_stem>, air]]);
craftingTable.addShaped("warped_post_saw", <item:quark:warped_post>*6, [[<item:minecraft:warped_stem>, <tag:items:kapphobins:saw>],[<item:minecraft:warped_stem>, air]]);
...
// QUARK - ANCIENT
craftingTable.addShaped("ancient_pressure_plate_saw", <item:quark:ancient_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:quark:ancient_planks>, <item:quark:ancient_planks>]]);
craftingTable.addShaped("ancient_planks_from_stripped", <item:quark:ancient_planks>*6, [[<item:quark:stripped_ancient_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("ancient_planks_from_log", <item:quark:ancient_planks>*6, [[<item:quark:ancient_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("ancient_post_stripped_saw", <item:quark:stripped_ancient_post>*6, [[<item:quark:stripped_ancient_log>, <tag:items:kapphobins:saw>],[<item:quark:stripped_ancient_log>, air]]);
craftingTable.addShaped("ancient_post_saw", <item:quark:ancient_post>*6, [[<item:quark:ancient_log>, <tag:items:kapphobins:saw>],[<item:quark:ancient_log>, air]]);
...
// QUARK - AZALEA
craftingTable.addShaped("azalea_pressure_plate_saw", <item:quark:azalea_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:quark:azalea_planks>, <item:quark:azalea_planks>]]);
craftingTable.addShaped("azalea_planks_from_stripped", <item:quark:azalea_planks>*6, [[<item:quark:stripped_azalea_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("azalea_planks_from_log", <item:quark:azalea_planks>*6, [[<item:quark:azalea_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("azalea_post_stripped_saw", <item:quark:stripped_azalea_post>*6, [[<item:quark:stripped_azalea_log>, <tag:items:kapphobins:saw>],[<item:quark:stripped_azalea_log>, air]]);
craftingTable.addShaped("azalea_post_saw", <item:quark:azalea_post>*6, [[<item:quark:azalea_log>, <tag:items:kapphobins:saw>],[<item:quark:azalea_log>, air]]);
...
// QUARK - BLOSSOM
craftingTable.addShaped("blossom_pressure_plate_saw", <item:quark:blossom_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:quark:blossom_planks>, <item:quark:blossom_planks>]]);
craftingTable.addShaped("blossom_post_stripped_saw", <item:quark:stripped_blossom_post>*6, [[<item:quark:blossom_planks>, <tag:items:kapphobins:saw>],[<item:quark:blossom_planks>, air]]);
craftingTable.addShaped("blossom_post_saw", <item:quark:blossom_post>*6, [[<item:quark:blossom_planks>, <tag:items:kapphobins:saw>],[<item:quark:blossom_planks>, air]]);
...
// VINERY - DARK CHERRY
craftingTable.addShaped("dark_cherry_pressure_plate_saw", <item:vinery:dark_cherry_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:vinery:dark_cherry_planks>, <item:vinery:dark_cherry_planks>]]);
craftingTable.addShaped("dark_cherry_planks_from_stripped", <item:vinery:dark_cherry_planks>*6, [[<item:vinery:stripped_dark_cherry_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("dark_cherry_planks_from_log", <item:vinery:dark_cherry_planks>*6, [[<item:vinery:dark_cherry_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("cobalt_pressure_plate_saw", <item:regions_unexplored:cobalt_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:cobalt_planks>, <item:regions_unexplored:cobalt_planks>]]);
craftingTable.addShaped("cobalt_planks_from_stripped", <item:regions_unexplored:cobalt_planks>*6, [[<item:regions_unexplored:stripped_cobalt_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("cobalt_planks_from_log", <item:regions_unexplored:cobalt_planks>*6, [[<item:regions_unexplored:cobalt_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("cypress_pressure_plate_saw", <item:regions_unexplored:cypress_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:cypress_planks>, <item:regions_unexplored:cypress_planks>]]);
craftingTable.addShaped("cypress_planks_from_stripped", <item:regions_unexplored:cypress_planks>*6, [[<item:regions_unexplored:stripped_cypress_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("cypress_planks_from_log", <item:regions_unexplored:cypress_planks>*6, [[<item:regions_unexplored:cypress_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("dead_pressure_plate_saw", <item:regions_unexplored:dead_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:dead_planks>, <item:regions_unexplored:dead_planks>]]);
craftingTable.addShaped("dead_planks_from_stripped", <item:regions_unexplored:dead_planks>*6, [[<item:regions_unexplored:stripped_dead_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("dead_planks_from_log", <item:regions_unexplored:dead_planks>*6, [[<item:regions_unexplored:dead_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("mauve_pressure_plate_saw", <item:regions_unexplored:mauve_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:mauve_planks>, <item:regions_unexplored:mauve_planks>]]);
craftingTable.addShaped("mauve_planks_from_stripped", <item:regions_unexplored:mauve_planks>*6, [[<item:regions_unexplored:stripped_mauve_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("mauve_planks_from_log", <item:regions_unexplored:mauve_planks>*6, [[<item:regions_unexplored:mauve_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("maple_pressure_plate_saw", <item:regions_unexplored:maple_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:maple_planks>, <item:regions_unexplored:maple_planks>]]);
craftingTable.addShaped("maple_planks_from_stripped", <item:regions_unexplored:maple_planks>*6, [[<item:regions_unexplored:stripped_maple_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("maple_planks_from_log", <item:regions_unexplored:maple_planks>*6, [[<item:regions_unexplored:maple_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("magnolia_pressure_plate_saw", <item:regions_unexplored:magnolia_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:magnolia_planks>, <item:regions_unexplored:magnolia_planks>]]);
craftingTable.addShaped("magnolia_planks_from_stripped", <item:regions_unexplored:magnolia_planks>*6, [[<item:regions_unexplored:stripped_magnolia_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("magnolia_planks_from_log", <item:regions_unexplored:magnolia_planks>*6, [[<item:regions_unexplored:magnolia_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("green_bioshroom_pressure_plate_saw", <item:regions_unexplored:green_bioshroom_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:green_bioshroom_planks>, <item:regions_unexplored:green_bioshroom_planks>]]);
craftingTable.addShaped("green_bioshroom_planks_from_stripped", <item:regions_unexplored:green_bioshroom_planks>*6, [[<item:regions_unexplored:stripped_green_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("green_bioshroom_planks_from_log", <item:regions_unexplored:green_bioshroom_planks>*6, [[<item:regions_unexplored:green_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("blackwood_pressure_plate_saw", <item:regions_unexplored:blackwood_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:blackwood_planks>, <item:regions_unexplored:blackwood_planks>]]);
craftingTable.addShaped("blackwood_planks_from_stripped", <item:regions_unexplored:blackwood_planks>*6, [[<item:regions_unexplored:stripped_blackwood_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("blackwood_planks_from_log", <item:regions_unexplored:blackwood_planks>*6, [[<item:regions_unexplored:blackwood_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("blue_bioshroom_pressure_plate_saw", <item:regions_unexplored:blue_bioshroom_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:blue_bioshroom_planks>, <item:regions_unexplored:blue_bioshroom_planks>]]);
craftingTable.addShaped("blue_bioshroom_planks_from_stripped", <item:regions_unexplored:blue_bioshroom_planks>*6, [[<item:regions_unexplored:stripped_blue_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("blue_bioshroom_planks_from_log", <item:regions_unexplored:blue_bioshroom_planks>*6, [[<item:regions_unexplored:blue_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("brimwood_pressure_plate_saw", <item:regions_unexplored:brimwood_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:brimwood_planks>, <item:regions_unexplored:brimwood_planks>]]);
craftingTable.addShaped("brimwood_planks_from_stripped", <item:regions_unexplored:brimwood_planks>*6, [[<item:regions_unexplored:stripped_brimwood_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("brimwood_planks_from_log", <item:regions_unexplored:brimwood_planks>*6, [[<item:regions_unexplored:brimwood_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("eucalyptus_pressure_plate_saw", <item:regions_unexplored:eucalyptus_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:eucalyptus_planks>, <item:regions_unexplored:eucalyptus_planks>]]);
craftingTable.addShaped("eucalyptus_planks_from_stripped", <item:regions_unexplored:eucalyptus_planks>*6, [[<item:regions_unexplored:stripped_eucalyptus_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("eucalyptus_planks_from_log", <item:regions_unexplored:eucalyptus_planks>*6, [[<item:regions_unexplored:eucalyptus_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("larch_pressure_plate_saw", <item:regions_unexplored:larch_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:larch_planks>, <item:regions_unexplored:larch_planks>]]);
craftingTable.addShaped("larch_planks_from_stripped", <item:regions_unexplored:larch_planks>*6, [[<item:regions_unexplored:stripped_larch_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("larch_planks_from_log", <item:regions_unexplored:larch_planks>*6, [[<item:regions_unexplored:larch_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("redwood_pressure_plate_saw", <item:regions_unexplored:redwood_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:redwood_planks>, <item:regions_unexplored:redwood_planks>]]);
craftingTable.addShaped("redwood_planks_from_stripped", <item:regions_unexplored:redwood_planks>*6, [[<item:regions_unexplored:stripped_redwood_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("redwood_planks_from_log", <item:regions_unexplored:redwood_planks>*6, [[<item:regions_unexplored:redwood_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("pink_bioshroom_pressure_plate_saw", <item:regions_unexplored:pink_bioshroom_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:pink_bioshroom_planks>, <item:regions_unexplored:pink_bioshroom_planks>]]);
craftingTable.addShaped("pink_bioshroom_planks_from_stripped", <item:regions_unexplored:pink_bioshroom_planks>*6, [[<item:regions_unexplored:stripped_pink_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("pink_bioshroom_planks_from_log", <item:regions_unexplored:pink_bioshroom_planks>*6, [[<item:regions_unexplored:pink_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("baobab_pressure_plate_saw", <item:regions_unexplored:baobab_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:baobab_planks>, <item:regions_unexplored:baobab_planks>]]);
craftingTable.addShaped("baobab_planks_from_stripped", <item:regions_unexplored:baobab_planks>*6, [[<item:regions_unexplored:stripped_baobab_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("baobab_planks_from_log", <item:regions_unexplored:baobab_planks>*6, [[<item:regions_unexplored:baobab_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("pine_pressure_plate_saw", <item:regions_unexplored:pine_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:pine_planks>, <item:regions_unexplored:pine_planks>]]);
craftingTable.addShaped("pine_planks_from_stripped", <item:regions_unexplored:pine_planks>*6, [[<item:regions_unexplored:stripped_pine_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("pine_planks_from_log", <item:regions_unexplored:pine_planks>*6, [[<item:regions_unexplored:pine_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("joshua_pressure_plate_saw", <item:regions_unexplored:joshua_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:joshua_planks>, <item:regions_unexplored:joshua_planks>]]);
craftingTable.addShaped("joshua_planks_from_stripped", <item:regions_unexplored:joshua_planks>*6, [[<item:regions_unexplored:stripped_joshua_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("joshua_planks_from_log", <item:regions_unexplored:joshua_planks>*6, [[<item:regions_unexplored:joshua_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("socotra_pressure_plate_saw", <item:regions_unexplored:socotra_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:socotra_planks>, <item:regions_unexplored:socotra_planks>]]);
craftingTable.addShaped("socotra_planks_from_stripped", <item:regions_unexplored:socotra_planks>*6, [[<item:regions_unexplored:stripped_socotra_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("socotra_planks_from_log", <item:regions_unexplored:socotra_planks>*6, [[<item:regions_unexplored:socotra_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("willow_pressure_plate_saw", <item:regions_unexplored:willow_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:willow_planks>, <item:regions_unexplored:willow_planks>]]);
craftingTable.addShaped("willow_planks_from_stripped", <item:regions_unexplored:willow_planks>*6, [[<item:regions_unexplored:stripped_willow_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("willow_planks_from_log", <item:regions_unexplored:willow_planks>*6, [[<item:regions_unexplored:willow_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("yellow_bioshroom_pressure_plate_saw", <item:regions_unexplored:yellow_bioshroom_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:yellow_bioshroom_planks>, <item:regions_unexplored:yellow_bioshroom_planks>]]);
craftingTable.addShaped("yellow_bioshroom_planks_from_stripped", <item:regions_unexplored:yellow_bioshroom_planks>*6, [[<item:regions_unexplored:stripped_yellow_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("yellow_bioshroom_planks_from_log", <item:regions_unexplored:yellow_bioshroom_planks>*6, [[<item:regions_unexplored:yellow_bioshroom_stem>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("palm_pressure_plate_saw", <item:regions_unexplored:palm_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:palm_planks>, <item:regions_unexplored:palm_planks>]]);
craftingTable.addShaped("palm_planks_from_stripped", <item:regions_unexplored:palm_planks>*6, [[<item:regions_unexplored:stripped_palm_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("palm_planks_from_log", <item:regions_unexplored:palm_planks>*6, [[<item:regions_unexplored:palm_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("kapok_pressure_plate_saw", <item:regions_unexplored:kapok_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:regions_unexplored:kapok_planks>, <item:regions_unexplored:kapok_planks>]]);
craftingTable.addShaped("kapok_planks_from_stripped", <item:regions_unexplored:kapok_planks>*6, [[<item:regions_unexplored:stripped_kapok_log>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("kapok_planks_from_log", <item:regions_unexplored:kapok_planks>*6, [[<item:regions_unexplored:kapok_log>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("oak_pressure_plate", <item:minecraft:oak_pressure_plate>*3, [[<tag:items:kapphobins:saw>, air],[<item:minecraft:oak_planks>, <item:minecraft:oak_planks>]]);

craftingTable.addShaped("planks2", <item:minecraft:oak_planks>*6, [[<item:minecraft:stripped_oak_log>, <tag:items:kapphobins:saw>]]);

craftingTable.addShaped("planks", <item:minecraft:oak_planks>*6, [[<item:minecraft:oak_log>, <tag:items:kapphobins:saw>]]);

craftingTable.addShaped("post_stripped", <item:quark:stripped_oak_post>*6, [[<item:minecraft:stripped_oak_log>, <tag:items:kapphobins:saw>],[<item:minecraft:stripped_oak_log>, air]]);

craftingTable.addShaped("post", <item:quark:oak_post>*6, [[<item:minecraft:oak_log>, <tag:items:kapphobins:saw>],[<item:minecraft:oak_log>, air]]);
...
craftingTable.addShaped("oak_button", <item:minecraft:oak_button>*4, [[<item:minecraft:oak_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("spruce_button", <item:minecraft:spruce_button>*4, [[<item:minecraft:spruce_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("birch_button", <item:minecraft:birch_button>*4, [[<item:minecraft:birch_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("jungle_button", <item:minecraft:jungle_button>*4, [[<item:minecraft:jungle_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("acacia_button", <item:minecraft:acacia_button>*4, [[<item:minecraft:acacia_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("dark_oak_button", <item:minecraft:dark_oak_button>*4, [[<item:minecraft:dark_oak_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("mangrove_button", <item:minecraft:mangrove_button>*4, [[<item:minecraft:mangrove_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("cherry_button", <item:minecraft:cherry_button>*4, [[<item:minecraft:cherry_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("ancient_button", <item:quark:ancient_button>*4, [[<item:quark:ancient_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("azalea_button", <item:quark:azalea_button>*4, [[<item:quark:azalea_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("blossom_button", <item:quark:blossom_button>*4, [[<item:quark:blossom_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("bamboo_button", <item:minecraft:bamboo_button>*4, [[<item:minecraft:bamboo_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("dark_cherry_button", <item:vinery:dark_cherry_button>*4, [[<item:vinery:dark_cherry_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("cobalt_button", <item:regions_unexplored:cobalt_button>*4, [[<item:regions_unexplored:cobalt_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("cypress_button", <item:regions_unexplored:cypress_button>*4, [[<item:regions_unexplored:cypress_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("dead_button", <item:regions_unexplored:dead_button>*4, [[<item:regions_unexplored:dead_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("mauve_button", <item:regions_unexplored:mauve_button>*4, [[<item:regions_unexplored:mauve_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("maple_button", <item:regions_unexplored:maple_button>*4, [[<item:regions_unexplored:maple_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("magnolia_button", <item:regions_unexplored:magnolia_button>*4, [[<item:regions_unexplored:magnolia_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("green_bioshroom_button", <item:regions_unexplored:green_bioshroom_button>*4, [[<item:regions_unexplored:green_bioshroom_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("crimson_button", <item:minecraft:crimson_button>*4, [[<item:minecraft:crimson_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("blackwood_button", <item:regions_unexplored:blackwood_button>*4, [[<item:regions_unexplored:blackwood_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("blue_bioshroom_button", <item:regions_unexplored:blue_bioshroom_button>*4, [[<item:regions_unexplored:blue_bioshroom_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("brimwood_button", <item:regions_unexplored:brimwood_button>*4, [[<item:regions_unexplored:brimwood_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("eucalyptus_button", <item:regions_unexplored:eucalyptus_button>*4, [[<item:regions_unexplored:eucalyptus_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("larch_button", <item:regions_unexplored:larch_button>*4, [[<item:regions_unexplored:larch_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("redwood_button", <item:regions_unexplored:redwood_button>*4, [[<item:regions_unexplored:redwood_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("pink_bioshroom_button", <item:regions_unexplored:pink_bioshroom_button>*4, [[<item:regions_unexplored:pink_bioshroom_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("baobab_button", <item:regions_unexplored:baobab_button>*4, [[<item:regions_unexplored:baobab_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("pine_button", <item:regions_unexplored:pine_button>*4, [[<item:regions_unexplored:pine_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("joshua_button", <item:regions_unexplored:joshua_button>*4, [[<item:regions_unexplored:joshua_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("socotra_button", <item:regions_unexplored:socotra_button>*4, [[<item:regions_unexplored:socotra_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("willow_button", <item:regions_unexplored:willow_button>*4, [[<item:regions_unexplored:willow_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("yellow_bioshroom_button", <item:regions_unexplored:yellow_bioshroom_button>*4, [[<item:regions_unexplored:yellow_bioshroom_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("warped_button", <item:minecraft:warped_button>*4, [[<item:minecraft:warped_planks>, <tag:items:kapphobins:saw>]]);
craftingTable.addShaped("palm_button", <item:regions_unexplored:palm_button>*4, [[<item:regions_unexplored:palm_planks>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShaped("kapok_button", <item:regions_unexplored:kapok_button>*4, [[<item:regions_unexplored:kapok_planks>, <tag:items:kapphobins:saw>]]);
...
craftingTable.addShapeless("sand_shovel_head_cast", <item:kapphobins_addons:sandshovelheadcast>, [<item:minecraft:sand>]);
craftingTable.addShapeless("red_sand_shovel_head_cast", <item:kapphobins_addons:red_sandshovelheadcast>, [<item:minecraft:red_sand>]);
craftingTable.addShapeless("sand_hoe_cast", <item:kapphobins_addons:sand_hoe_cast>, [<item:minecraft:sand>]);
craftingTable.addShapeless("red_sand_hoe_cast", <item:kapphobins_addons:red_sand_hoe_cast>, [<item:minecraft:red_sand>]);
// Author: Kapphobin
